set fish_color_normal dde4e2
set fish_color_command ffb68a
set fish_color_param e4c36c
set fish_color_redirection $fish_color_param
set fish_color_comment a1d399
set fish_color_error ffb4ab
set fish_color_escape ffb4a3
